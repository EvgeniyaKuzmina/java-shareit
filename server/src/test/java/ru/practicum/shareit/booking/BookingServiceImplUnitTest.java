...
class BookingServiceImplUnitTest {
    ...
    void getLastOrNextBookingForItem() {
        ...
        MatcherAssert.assertThat(lastBookingForItem.getBookerId(), equalTo(pastBooking.getBooker().getId()));
        ...
        MatcherAssert.assertThat(nextBookingForItem.getBookerId(), equalTo(booking.getBooker().getId()));
